...
export async function joinStreaming({
  ...
  const res = await fetch(`http://localhost:3000/api/streaming/${signed}`, {
    method: "GET",
  });
...
export async function startRecordStreaming({
  ...
  const res = await fetch(
    `http://localhost:3000/api/streaming/record/start-record/${slug}`,
    {
      method: "GET",
      headers: {
...
export async function stopRecordStreaming({
  ...
  const res = await fetch(
    `http://localhost:3000/api/streaming/record/stop-record/${slug}`,
    {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
...
export async function getIsRecording({
  ...
  const res = await fetch(
    `http://localhost:3000/api/streaming/record/${slug}`,
    {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
